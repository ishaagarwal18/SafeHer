        ...
        <div className="journey-shell">
          ...
          <header className="journey-heading">
            ...
            <div>
              ...
              <p>Share your journey plan with trusted contacts and get safety check-ins.</p>
            </div>
          </header>
            ...
            >
              <div>
                ...
                <p style={{ margin: "0", fontSize: "13px", color: "#64748b" }}>
                  ⏱ Estimated Time: <strong>~{activeJourney.expected_duration_minutes || 30} mins</strong> (
                  {activeJourney.transport_mode || "Car"}) • Safety check every 10 mins
                </p>
              </div>
          ...
          <section className="recent-journeys">
            ...
            {fetching ? (
              <div style={{ padding: "30px 0" }}>
                <Loader message="Loading recent journeys..." />
              </div>
            ) : (
                      ...
                      journeys.slice(0, 5).map((journey, index) => {
                        ...
                        return (
                          <tr key={journey.id || index}>
                            ...
                            <td>{transportMode}</td>
                            <td>
                              {journey.start_time ? new Date(journey.start_time).toLocaleString() : "Just now"}
                            </td>
                            <td>
                              <span className={`journey-status ${statusClass(journey.status)}`}>
