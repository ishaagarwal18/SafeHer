        ...
        <div className="container">
            ...
            <div className="grid">
                <div className="feature-card sos-card" onClick={() => navigate("/sos")}>
                    ...
                    <Link to="/sos" onClick={(e) => e.stopPropagation()}>
                        Open
                    </Link>
                </div>
                ...
                <div className="feature-card" onClick={() => navigate("/contacts")}>
                    ...
                    <Link to="/contacts" onClick={(e) => e.stopPropagation()}>
                        Open
                    </Link>
                </div>
                ...
                <div className="feature-card" onClick={() => navigate("/journey")}>
                    ...
                    <Link to="/journey" onClick={(e) => e.stopPropagation()}>
                        Open
                    </Link>
                </div>
                ...
                <div className="feature-card" onClick={() => navigate("/safe-places")}>
                    ...
                    <Link to="/safe-places" onClick={(e) => e.stopPropagation()}>
                        Open
                    </Link>
                </div>
                ...
                <div className="feature-card" onClick={() => navigate("/history")}>
                    ...
                    <Link to="/history" onClick={(e) => e.stopPropagation()}>
                        Open
                    </Link>
                </div>
            </div>
