...
from .api_views import (
    ...
    api_journeys,
    journey_api,
    journey_estimate_api,
    active_journey_api,
    journey_complete_api,
    journey_check_in_api,
    api_sos,
    sos_api,
    api_reports,
    report_api,
...
urlpatterns = [
    ...
    path("api/journey/estimate/", journey_estimate_api, name="journey-estimate-api"),
    path("api/journey/active/", active_journey_api, name="active-journey-api"),
    path("api/journey/<int:journey_id>/complete/", journey_complete_api, name="journey-complete-api"),
    path("api/journey/<int:journey_id>/check-in/", journey_check_in_api, name="journey-check-in-api"),
